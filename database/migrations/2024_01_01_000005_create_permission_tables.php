...
{
    /**
     * Schema standard de spatie/laravel-permission (mode sans "teams").
     * Sert de support a la matrice de permissions LTA (voir README.md
     * et database/seeders/RolePermissionSeeder.php).
     */
